...
let UsersController = class UsersController {
    ...
    create(dto) { return this.usersService.create(dto); }
    update(id, dto) { return this.usersService.update(id, dto); }
    assignRoles(id, dto) { return this.usersService.assignRoles(id, dto); }
    remove(id) { return this.usersService.remove(id); }
};
exports.UsersController = UsersController;
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.Permissions)('user:page:view'),
...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.Permissions)('user:button:create'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.Permissions)('user:button:edit'),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('user:button:assign-role'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('user:button:delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
